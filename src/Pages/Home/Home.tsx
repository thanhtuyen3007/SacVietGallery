...
export const Home = () => {
  return (
    <article className="home-container w-screen lg:h-screen relative overflow-hidden">
      ...
      <div className={clsx(styles.image ,"lg:h-screen absolute top-0 right-0 -z-10 animation-pan")}>
        <img
